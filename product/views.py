...
class AboutUsView(TemplateView):
    template_name = 'about.html'  # Create this template in your templates directory

class ContactUsView(FormView):
    template_name = 'contact.html'  # Create this template in your templates directory
    form_class = ContactForm  # Use a form class to handle contact submissions
    success_url = reverse_lazy('contact_success')  # Redirect after successful submission

    def form_valid(self, form):
        # Here you would typically send an email or save the form data to the database
        form.send_email()  # Assuming your form has a send_email method
